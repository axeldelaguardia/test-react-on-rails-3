...
const Settings = ({user, name, email, timezone, image_name, background_path}) => {
  ...
  return (
    <PageLayout className={style.mainLayout} userImage={image_name} user={user} background={localBackgroundPath}>
      <Layout className={style.settingsPart}>
        ...
        <div className={style.contentLayout}>
          <Content className={style.content}>
            ...
            {selectedMenuItem === '3' && <ProfileSettings profile_pic_path={image_name}/>}
            {selectedMenuItem === '4' && (
              <Background
